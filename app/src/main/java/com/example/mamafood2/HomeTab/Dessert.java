...
public class Dessert extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_dessert, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        SearchView searchView = view.findViewById(R.id.search_dessert);
        ...
        recyclerView = view.findViewById(R.id.rcv_dessert);
